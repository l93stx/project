# Проект: Интеллектуальный Travel-Помощник
# Описание логики: Принимает координаты пользователя, запрашивает текущую погоду через Open-Meteo API, 
# передает данные в GigaChat для генерации персональных рекомендаций и сохраняет историю в БД PostgreSQL.
